...
const programs = [
  ...
  { id: 'speak-up', name: 'Speak Up', price: 175000 },
  { id: 'tka', name: 'TKA', price: 200000 },
  { id: 'cpns', name: 'CPNS', price: 250000 },
  { id: 'skripsi', name: 'Skripsi', price: 300000 }
]
                        ...
                        <div key={program.id} className="relative">
                          ...
                          >
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-sm text-gray-500">Rp {program.price.toLocaleString('id-ID')}</span>
                            </div>
                          </label>
                        </div>
                      ))}
